...
public class ItemDropManager : MonoBehaviour
{
    ...
    public float maxDistance = 5.0f;       // 아이템 드롭 거리
    ...
    public void DropItem_UI(ItemDataSO itemData, int quantity)
    {
    ...
    public void DropItem_PlayerAction()
    {
        var index = ScriptManager.Instance.itemEquipmentManager.selectedSlotIndex;
        var slot = ScriptManager.Instance.inventory.slots[index];
